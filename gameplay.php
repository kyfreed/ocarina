<html>
    <head>
        ...
        <title>Ocarina of Time - Gameplay</title>
    </head>
    <body style="font-family: 'Arial'; font-size: 24px; background-color: rgb(22,69,110); color: #d2d2d2">
        ...
        <img src='clock.jpg'>
        <br>
        <p>This clock constantly ticks on, and if you don't go back in time before the third day ends, the world ends. I don't like this type of pressure; I like exploring freely.</p>
    </body>
</html>
...
<html>
    ...
    <body>
        ...
        <button class="btn btn-primary" style="background-color: #213253; color: #fafdf9" onclick="window.location.href = '/impact.php'">Impact</button>
    </body>
</html>
